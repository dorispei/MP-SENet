...
def train(rank, a, h):
    ...
    if rank == 0:
        validset = Dataset(validation_indexes, a.input_clean_wavs_dir, a.input_noisy_wavs_dir,
                           h.segment_size, h.n_fft, h.hop_size, h.win_size, h.sampling_rate, h.compress_factor,
                           split=True, shuffle=False, n_cache_reuse=0, device=device)
...
def main():
    ...
    parser.add_argument('--input_clean_wavs_dir', default='/home/hanchenpei/data/sgmse_data/train/clean/')
    parser.add_argument('--input_noisy_wavs_dir', default='/home/hanchenpei/data/sgmse_data/train/noisy/')
    parser.add_argument('--input_training_file', default='/home/hanchenpei/data/MP_SENet/training.txt')
    parser.add_argument('--input_validation_file', default='/home/hanchenpei/data/MP_SENet/test.txt')
    parser.add_argument('--checkpoint_path', default='model_0815_tf')
